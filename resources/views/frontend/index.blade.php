                            ...
                            <div class="latest-prdouct__slider__item">
                                ...
                                <a href="#" class="latest-product__item">
                                    <div class="latest-product__item__pic">
                                        <img src="{{asset($photo)}}" alt="" style="width: 150px;height: 95px;object-fit: cover;">
                                    </div>
                                    <div class="latest-product__item__text">
                                        <h6>{{Str::limit($latestitem->name,20)}}</h6>
                                            @if($latest_discountprice)
                                            <span>{{$latest_discountprice}} Ks</span>
                                            <del class="text-muted">{{$latest_unitprice}} Ks</del>
                                            @else
                                ...
                                <a href="#" class="latest-product__item">
                                    ...
                                    <div class="latest-product__item__text">
                                        ...
                                        @if($top_discountprice)
                                            ...
                                            <del class="text-muted">{{$top_unitprice}} Ks</del>
                                            @else
                    ...
                    <div class="latest-product__text">
                        ...
                        <div class="latest-product__slider owl-carousel">
                            <div class="latest-prdouct__slider__item">
                                 ...
                                 $discountitem_unitprice=$discountitem->price;
                                 $discountprice=$discountitem->discount;
                                 @endphp
                                <a href="#" class="latest-product__item">
                                    <div class="latest-product__item__pic">
                                        <img src="{{asset($photo)}}" alt=""
                                    ...
                                    <div class="latest-product__item__text">
                                        ...
                                        @if($discountprice)
                                            <span>{{$discountprice}} Ks</span>
                                            <del class="text-muted">{{$discountitem_unitprice}} Ks</del>
                                            @else
                                            <span>{{$discountitem_unitprice}} Ks</span>
                                            @endif 
                                    </div>
                                </a>
                                @endforeach
