            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        ...
                        <form action="{{route('backside.category.destroy',$id)}}" method="POST" class="d-inline-block" onsubmit="return confirm('Are you sure sir?')">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"><i class="icofont-close icofont-1x"></i></button>
                                                </form>
                                            </td>
