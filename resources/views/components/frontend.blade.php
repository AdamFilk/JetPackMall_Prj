...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__cart">
            <ul>
                <li>
                    <a href="#"><i class="fa fa-shopping-bag"></i> <span class="shoppingcartNoti cartNoti"></span>
                    </a>
                </li>
            </ul>
            <a href="">
                <div class="header__cart__price">
                    item: <span class="shoppingcartTotal cartTotal"></span>
                </div>
            </a>
        </div>
            ...
            <ul>
                ...
                <li><a href="#"> Merchants </a>
                    <ul class="header__menu__dropdown">
                        ...
                        @endphp
                        <li><a href="{{route('brand',$brand->id)}}">{{$brand_name}}</a></li>
                        @endforeach
                    </ul>
                </li>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        <ul>
                            <li>
                                <a href="{{route('cart')}}"><i class="fa fa-shopping-bag"></i> <span class="shoppingcartNoti cartNoti"></span></a>
                            </li>
                        </ul>
                        <a href="">
                            <div class="header__cart__price">item: <span class="shoppingcartTotal cartTotal"></span></div>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        ...
                        <ul>
                            ...
                            <li>E-mail:<a href="mailto:adsltheprescence@gmail.com">adsltheprescence@gmail.com</a> </li>
                        </ul>
                    </div>
                </div>
    ...
    <script type="text/javascript" src="{{asset('shoppingcart.js')}}"></script>
