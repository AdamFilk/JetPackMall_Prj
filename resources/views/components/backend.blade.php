...
<html lang="en">
    ...
    <body class="app sidebar-mini">
        ...
        <aside class="app-sidebar">
            <div class="app-sidebar__user"><img class="app-sidebar__user-avatar img-fluid w-25" src="{{asset(Auth::user()->profile)}}" alt="User Image">
                <div>
        ...
        {{-- Mulitple Image Upload & Preview Js --}}
        <script type="text/javascript" src="{{asset('multipleimageupload/image-uploader.min.js')}}"></script>
